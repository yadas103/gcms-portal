...
(function() {
  ...
  angular
    ...
    .factory('ExcelFileMonitor', ExcelFileMonitor);

  ExcelFileMonitor.$inject = ['$resource', '$locale', 'localeMapper', 'ENVIRONMENT'];
   ...
   */
  function ExcelFileMonitor($resource, $locale, localeMapper, ENVIRONMENT) {
    return $resource(
      ENVIRONMENT.SERVICE_URI + ':locale/excel-upload' + ENVIRONMENT.SERVICE_EXT,
      {
