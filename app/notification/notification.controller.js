/*(function() {
	...
	angular.module('gcms.notification',['ui.bootstrap']).controller('NotificationCtrl',NotificationController);

	NotificationController.$inject = [ '$rootScope', '$scope', '$filter','Notification', 'Users', 'toasty', '$http', 'session' ];

	function NotificationController($rootScope, $scope,$filter,Notification,Users,toasty,$http,session){
		
		  console.log("Inside excel controller");
		  ...
		  *//**
			 * 
			 * @methodOf this method used select template
			 * 
			 *//*
